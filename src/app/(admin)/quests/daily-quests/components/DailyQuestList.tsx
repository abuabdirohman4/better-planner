        ...
        <div className="bg-gray-50 dark:bg-gray-900/50 rounded-lg p-4 border border-gray-200 dark:border-gray-800 mb-6">
          ...
          <form onSubmit={handleAddQuest} className="flex gap-3">
            <input
              ...
              autoFocus
              data-testid="daily-quest-new-title-input"
            />
            <Button
              type="submit"
              ...
              loading={isAdding}
              size="sm"
              data-testid="daily-quest-submit-btn"
            >
              Tambah
            </Button>
          </form>
      ...
      <div className="space-y-1">
        {filteredQuests.length === 0 ? (
          ...
          filteredQuests.map((quest) => {
            ...
            return (
              <div key={quest.id} data-testid={`daily-quest-item-${quest.id}`} className="group flex items-center justify-between py-2 px-3 hover:bg-gray-50 dark:hover:bg-gray-800/50 rounded-lg transition-all border border-transparent hover:border-gray-100 dark:hover:border-gray-700">
                {isEditing ? (
                  ...
                  <>
                    ...
                    <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                      {!quest.is_archived && (
                        <>
                          <button
                            ...
                            title="Edit"
                            data-testid={`daily-quest-edit-${quest.id}`}
                          >
                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <button
                        ...
                        data-testid={`daily-quest-delete-${quest.id}`}
                      >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
