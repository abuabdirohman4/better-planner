...
function WarningModal({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
...
function ErrorModal({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
...
export default function ModalBasedAlerts() {
  ...
  return (
    <ComponentCard title="Modal Based Alerts">
      ...
      <SuccessModal isOpen={successModal.isOpen} onClose={successModal.closeModal} />
      <InfoModal isOpen={infoModal.isOpen} onClose={infoModal.closeModal} />
      <WarningModal isOpen={warningModal.isOpen} onClose={warningModal.closeModal} />
      <ErrorModal isOpen={errorModal.isOpen} onClose={errorModal.closeModal} />
    </ComponentCard>
  );
}
