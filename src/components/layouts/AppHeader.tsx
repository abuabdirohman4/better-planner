...
const AppHeader: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 md:flex w-full bg-white border-gray-200 z-99999 lg:z-10 dark:border-gray-800 dark:bg-gray-900 lg:border-b">
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          {/* Toggle Sidebar */}
          <button
            className="items-center justify-center w-10 h-10 text-gray-500 border-gray-200 rounded-lg z-99999 dark:border-gray-800 hidden md:flex dark:text-gray-400 lg:h-11 lg:w-11 lg:border"
          ...
          <button
            ...
            className="flex items-center justify-center w-10 h-10 text-gray-700 rounded-lg z-99999 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800 hidden md:flex lg:hidden"
          >
            <svg
              width="24"
              height="24"
