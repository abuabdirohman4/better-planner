...
const i18n = {
  id: {
    ...
    actionTip: 'Aksi untuk Bulan Depan',
    noActivity: 'Tidak ada sesi fokus bulan ini — bulan depan adalah kesempatanmu!',
  },
  en: {
    tag: 'Monthly Summary',
    hi: 'Hi',
    ...
    actionTip: 'Action for Next Month',
    noActivity: 'No focus sessions this month — next month is your chance!',
  },
}
